...
package object snapshot {
  ...
  type SnapshotConsensus[F[_], S <: Snapshot, C <: SnapshotInfo[_], Event, StateKey, Status, Outcome, Kind] =
    Consensus[F, Event, StateKey, SnapshotKey, SnapshotArtifact[S], C, Status, Outcome, Kind]
