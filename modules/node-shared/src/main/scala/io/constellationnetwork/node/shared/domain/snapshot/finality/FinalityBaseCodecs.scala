...
private[finality] object FinalityBaseCodecs {
  ...
  implicit val finalityArtifactKindCodec: Codec[FinalityArtifactKind] =
    discriminated[FinalityArtifactKind]
      ...
      .typecase(12, provide(FinalityArtifactKind.AuthenticatedAnchorReceipt))
      .typecase(13, provide(FinalityArtifactKind.PriorSemanticStateReceipt))
      .typecase(14, provide(FinalityArtifactKind.PriorAnchorReceipt))
      .typecase(15, provide(FinalityArtifactKind.EffectPayload))
