...
object SharedValidators {
  ...
  def make[F[_]: Async: JsonSerializer: SecurityProvider: Hasher](
    ...
    val updateDelegatedStakeValidator = UpdateDelegatedStakeValidator.make[F](signedValidator, l0Seedlist)
    val updateNodeCollateralValidator = UpdateNodeCollateralValidator.make[F](signedValidator, l0Seedlist)
