...
object ConsensusChainSyncWireKind {
  ...
  case object ChainPointComponent
      extends ConsensusChainSyncWireKind("transport.chainsync.wire.chain-point", ChainSyncSelectionHint)
  ...
  case object SnapshotResponse
      extends ConsensusChainSyncWireKind("transport.chainsync.wire.snapshot-response", ChainSyncSnapshotCarrier)
  ...
  case object GetPeerTipRequest
      extends ConsensusChainSyncWireKind("transport.chainsync.wire.get-peer-tip-request", ChainSyncSelectionHint)
  case object PeerTipResponse
      extends ConsensusChainSyncWireKind("transport.chainsync.wire.peer-tip-response", ChainSyncSelectionHint)
