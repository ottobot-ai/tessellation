...
| ECON-SLASH-001 | InvalidStateProof V1 is full-only over one unique exact-amount lock per stable offense-time `BondId` tranche unless O-23 selects and separately specifies a residual-lock design. Exact-amount replacement and pending withdrawal preserve the tranche; an increase creates a distinct tranche, a decrease cannot reduce open liability, and post-offense delegation is not charged. Debit the exact active or pending backing lock atomically with all four lifecycle maps, expiry index, per-signer field-34 identity, bounty, cooldown, accumulator, and evidence. Slash wins same-round/prior-round withdrawal, maturity, and replacement collisions. Bounty is at most actual debit; supply/root equality survives restart and density reorg. **CRITICAL RED/OPEN:** `InvalidStateProofSlashPrincipalRedSuite` compiles and fails 5/5 intended cases; SHA-256 `96f568291a4eee8e636debd814b8d8e4a3d5eebc6c3c2e06a5a752f4b3c04ca7`. |
...
|---|---|---|
| W0 | P0 decisions, architecture guard, finding ledger, RED harness | O-01 through O-17 owner directions are ratified; O-18 transport/DA bytes, O-19 migration policy, O-20 field-34 slash records, and O-21 optimistic decision evidence await owner responses. Dependent work remains blocked wherever the register names an owner, implementation, schema, parameter, research, RED-vector, or proof gate. |
