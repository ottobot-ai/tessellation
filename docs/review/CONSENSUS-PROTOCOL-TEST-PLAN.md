...
| P4.2 Permissionless roster contract (`BLOCKED ON O-11`) | Canonical Sybil-resistance/membership rule and period-boundary roster root with activation, exit, bond/stake, slash/cooldown, retention, and recovery semantics. Registration cannot create membership. | Owner ratifies O-11; P1 codecs/root ownership. | `KEYREG-013`, `PERM-*`, `PARAM-001`; self-signed registered outsider, live-peer/seedlist substitution, stake-splitting, and receiver-local roster are RED. |
