...
|---|---|---|
| W0 | P0 decisions, architecture guard, finding ledger, RED harness | O-01 through O-17 owner directions are ratified; O-18 transport/DA byte choices await owner response. Dependent work remains blocked wherever the register names an owner, implementation, schema, parameter, research, RED-vector, or proof gate. |
