...
| Owner decisions | Ratified optimistic/depth algebra, execution threshold, positive watchtower release, root fields, ML0 reorg rule, one-checkpoint batching, lane scope, and explicit remaining numeric/resource gates. O-18 and O-21 plus the post-register S2-ORDER-01..03, O13-A1 through O13-F including A3's exact schema/disposition, TL-EXP-1..4, and reward-algorithm choices remain owner stop-lines. O-19 is deferred with launch-profile-specific P12 and does not block greenfield runtime work. |
...
| P7 Diff/root/checkpoint | P7.0 first freezes the authority-free shared exact-context/checkpoint-reference schema; P4.4 then wires historical verification; remaining P7 owns checkpoint diff/root models/codecs, complete-root ownership, field-32 replay witness, and strict physical entries | P7.0: P1 plus P6 exact-ref value/evidence shape; remaining P7: P1/P2/P5/P6, P4.4 verified context, and root prerequisites | ROOT-007 complete coverage, ROOT-008 strict key grammar, ROOT-010 exact replay witness/removal order, and exact apply-diff vectors. |
...
| W2A | Dark P6 phase/lease/tower schemas and RED cores; dark P5 DA/intake schemas, REDs, and local custody primitives; P4.2 O-11/rooted roster contract; P4.3 exact historical resolver; PSIG boundaries; P7.0 shared exact-context/checkpoint-reference schema plus pure diff/root and ROOT-010 witness contracts/REDs | No runtime tower/eligibility activates before complete-root and executable O-11 historical authority. No live DA/intake byte wiring activates before O-18. Genesis consumers pass the immutable safety cut; all authority-bearing consumers remain blocked by their exact history/root/phase gates. |
