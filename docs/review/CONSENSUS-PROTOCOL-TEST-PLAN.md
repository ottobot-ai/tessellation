...
| P6 Durable FinalityGate/tower | node-shared finality store, tower/SMT, owned GL0 integration, and the FIN-14 lease kernel only after O-16 ratification | P1/PF; economic release hooks after P2 oracle; O-16 before consumer API freeze | Crash-consistent operational phase, load-bearing tower/SMT, arbitrary-depth density recovery, exact event outbox, and owner-ratified exact-consumer authority. |
