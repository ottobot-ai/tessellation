...
|---|---|---|
| W0 | P0 decisions, architecture guard, finding ledger, RED harness | O-01 through O-17, O-20 field-34 slash records, O-22 final-launch fraud-proof adjudication, and O-23 slash liability/bond tranches are ratified. O-18 transport/DA bytes, O-19 migration policy, and O-21 optimistic decision evidence await owner responses. Dependent work remains blocked wherever the register names an owner, implementation, schema, parameter, research, RED-vector, or proof gate. |
