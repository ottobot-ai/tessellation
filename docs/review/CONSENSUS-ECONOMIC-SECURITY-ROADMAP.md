...
| E0.2 | Preserve the completed O-01..O-17 owner dispositions in `CONSENSUS-OWNER-DECISIONS.md` and its answers companion. Keep O-18 through O-23 explicitly pending; close only the explicitly named engineering/research/schema/parameter/proof gates, and do not fill an unanswered owner choice with local policy. |
...
requires owner disposition of fixed-hash `BondId` plus complete `E-2` tranche
...
|---|---|---|
| W0 | E0 architecture/decision register, RED exploit corpus, finding ledger, test harness | All O-01..O-17 directions remain recorded as owner-ratified; O-18 through O-23 remain visibly pending; dependent engineering/research/schema/parameter gates and the capability matrix are explicit and assigned. |
